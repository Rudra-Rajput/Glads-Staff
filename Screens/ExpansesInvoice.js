...
const ExpansesInvoice = ({navigation}) => {
  return (
...
<StatusBar backgroundColor="#fa7452" />
  ...
  <ScrollView>
      ...
      style={{height: '96%', width: '100%', elevation: 9,}}>
      ...
      <View style={{flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center',marginHorizontal: '12%',marginTop: '4%'}}>
        ...
        <Text style={{color: '#000000', fontSize: 16}}>3563637735</Text>
      </View>



      <View style={{flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center',marginHorizontal: '12%',marginTop: '4%'}}>
        <Text style={{color: '#000000', fontSize: 16}}>Cotegory</Text>
        <Text style={{color: '#000000', fontSize: 16}}>Selected Option</Text>
      </View>
...
export default ExpansesInvoice
